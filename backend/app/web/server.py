...
def run() -> None:
    ...
    import backend.app.web.pages.agent as agent_page
    import backend.app.web.pages.card as card_page
    import backend.app.web.pages.chat as chat_page
    import backend.app.web.pages.index as index_page
    import backend.app.web.pages.status as status_page
