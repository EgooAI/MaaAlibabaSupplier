...
from backend.app.web.components.ai_suggestion import open_suggestion_dialog
from backend.app.web.components.analysis_dialog import open_analysis_dialog
from backend.app.web.components.card import generic_card, product_card
