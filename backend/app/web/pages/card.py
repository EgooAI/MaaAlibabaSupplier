...
from backend.app.shared.mitm.pool import get_generic_card_pool, get_inquiry_card_pool, get_product_card_pool
from backend.app.web.components.card import card_type_name, generic_card, inquiry_card, product_card
