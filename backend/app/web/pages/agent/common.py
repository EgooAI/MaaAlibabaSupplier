...
from backend.app.shared.agent.system_agents import SYSTEM_AGENT_APIDS
from backend.app.shared.crm.sdk import AgentPreset, AgentPresetManager

LEVELS = range(5)


def open_chat_action(apid: str, name: str):
    from backend.app.web.pages.agent.chat_dialog import open_agent_chat_dialog
