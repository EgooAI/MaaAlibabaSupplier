...
from backend.app.shared.crm.views import CrmConversation, CrmMessage, coerce_epoch, format_created_at
from backend.app.shared.mitm.pool import get_generic_card_pool, get_product_card_pool
from backend.app.shared.mitm.pool import GenericCard, ProductCard
from backend.app.web.components.card import card_type_name
