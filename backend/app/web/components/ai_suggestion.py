...
from backend.app.web.chat_presenter import conversation_rows
                ...
                for item in suggestion_state["items"]:
                    ...
                    with ui.card().props("flat bordered").classes("w-full p-3"):
                        with ui.column().classes("w-full gap-1"):
                            if zh_text:
                                with ui.column().classes("gap-0"):
                                    ui.label("中文").classes("text-xs text-gray-400 font-medium")
                        ...
                        with ui.row().classes("w-full justify-end"):
                            ...
                            ui.button("填充到输入框", icon="content_paste").props(
